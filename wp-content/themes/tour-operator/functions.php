...
function tour_operator_enqueue_styles() {
    ...
    $args = array(
      'family' => 'Nunito+Sans:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i',
  );

    wp_enqueue_style( 'tour-operator-google-fonts', add_query_arg( $args, "//fonts.googleapis.com/css" ) );
...
function tour_operator_customizer_theme_info( $wp_customize ){
    ...
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View demo', 'tour-operator' ) . ': </label><a href="' . esc_url( 'https://demo.raratheme.com/tour-operator/' ) . '" target="_blank">' . __( 'here', 'tour-operator' ) . '</a></span>';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'View documentation', 'tour-operator' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/documentation/tour-operator/' ) . '" target="_blank">' . __( 'here', 'tour-operator' ) . '</a></span>';
    $theme_info .= '<span class="sticky_info_row"><label class="row-element">' . __( 'Support ticket', 'tour-operator' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/support-ticket/' ) . '" target="_blank">' . __( 'here', 'tour-operator' ) . '</a></span>';
    $theme_info .= '<span class="sticky_info_row"><label class="more-detail row-element">' . __( 'More Details', 'tour-operator' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/wordpress-themes/' ) . '" target="_blank">' . __( 'here', 'tour-operator' ) . '</a></span>';
    $theme_info .= '</div>';
    ...
    $theme_demo_content_desc .= '<span><label class="row-element">' . __( 'Download Demo Content', 'tour-operator' ) . ': </label><a href="' . esc_url( 'https://raratheme.com/documentation/tour-operator/' ) . '" target="_blank" rel="nofollow noopener">' . __( 'Click here', 'tour-operator' ) . '</a></span><br />';
    ...
    <div class="footer-b">
        <div class="site-info">
            <?php
                ...
                echo '<a href="' . esc_url( 'https://raratheme.com/wordpress-themes/tour-operator/' ) .'" rel="author" target="_blank">' . esc_html__( 'Tour Operator', 'tour-operator' ) . '</a>' . esc_html__( ' by Rara Theme.', 'tour-operator' );
